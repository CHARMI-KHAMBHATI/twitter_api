...
public final class Utils {
    ...
    public static ArrayList<Tweets> fetchTweetData(String requestUrl) {
        // Create URL object
        ...
        ArrayList<Tweets> tweets = extractFeatureFromJson(jsonResponse);
    ...
    private static ArrayList<Tweets>  extractFeatureFromJson(String tweetJSON) {
        // If the JSON string is empty or null, then return early.
        if (TextUtils.isEmpty(tweetJSON)) {
        ...
        try {
            JSONObject baseJsonResponse = new JSONObject(tweetJSON);
            JSONArray featureArray = baseJsonResponse.getJSONArray("statuses");
            ...
            for(int i=0;i<featureArray.length();i++)
            {
               ...
               // JSONObject properties= c.getJSONObject("properties");
                ...
                tweets.add(new Tweets(time, text));
